      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-secondary">
            ...
            <div class="card-body">
                <form id="form" data-route="{{ route('machines.store') }}" method="POST">
                  @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="purchased_date" name="purchased_date" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="model_date" name="model_date" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" id="production_speed" name="production_speed" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="warranty_expiry" name="warranty" class="form-control" required>
                            </div>
                        </div>
...
$(document).ready(function() {
    $('#form').on('submit', function(event) {
        ...
        const form = $(this)[0]; // Get the form element
        ...
        $.ajax({
            ...
            contentType: false, // Ensure the content type is correct for file uploads
            headers: {
